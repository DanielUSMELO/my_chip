...
N 4010 -340 4130 -340 { lab=io_analog[1]}
...
C {devices/lab_pin.sym} 4130 -340 0 1 {name=l7 sig_type=std_logic lab=io_analog[1]}
...
C {devices/lab_pin.sym} 3600 -340 2 1 {name=l33 sig_type=std_logic lab=io_analog[2]}
C {devices/lab_pin.sym} 3550 -300 2 1 {name=l34 sig_type=std_logic lab=io_analog[3]}
C {/foss/designs/finalOpAmp.sym} 3800 -310 0 0 {name=x1}
